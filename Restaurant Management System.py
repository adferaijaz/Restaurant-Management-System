...
root.title("Adfer's Catering Business")
...
#===========================INFO============================================
lblInfo = Label(Tops, font=('Microsoft Sans',50, 'bold'),text="Adfer's Catering Business",fg="Steel Blue", bd=10,anchor='w')
lblInfo.grid(row=0,column=0)

lblInfo = Label(Tops, font=('Microsoft Sans',20, 'bold'),text=localtime,fg="Steel Blue", bd=10,anchor='w')
...
def Ref():
    ...
    CostofFries = CoF * 40
    CostofDrinks = CoD * 60
    CostofFilet = CoFilet * 80
    CostofBurger = CoBurger * 75
    CostChicken_Burger = CoChicBurger * 140
    CostCheese_Burger = CoCheese_Burger * 120
